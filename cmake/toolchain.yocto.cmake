...
SET(CMAKE_REQUIRED_FLAGS "--sysroot=${LEGATO_SYSROOT} -march=armv7-a -mthumb -mfpu=neon -mfloat-abi=hard" )
...
message("cmake flags ${CMAKE_REQUIRED_FLAGS}")
...
set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} ${TARGET_ARGS}")
set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} ${TARGET_ARGS}")
